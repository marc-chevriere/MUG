...
class ResidualGRU(nn.Module):
    def __init__(self, input_size, hidden_size, n_layers, batch_first):
        super().__init__()
        self.gru = nn.GRU(input_size, hidden_size, num_layers=n_layers, batch_first=batch_first)
