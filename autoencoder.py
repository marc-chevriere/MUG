...
from new_decoder import RNNDecoder, TransformerDecoderModel, RNNDecoderwAtt
...
class VariationalAutoEncoder(nn.Module):
    def __init__(self, input_dim, hidden_dim_enc, hidden_dim_dec, latent_dim, n_layers_enc, n_layers_dec, n_max_nodes, lambda_contrastive, beta=0.05):
        ...
        # self.decoder = RNNDecoderwAtt(latent_dim=latent_dim*2, hidden_dim=hidden_dim_dec, n_layers=n_layers_dec, max_nodes=n_max_nodes)
        self.decoder = TransformerDecoderModel(latent_dim=latent_dim*2, hidden_dim=hidden_dim_dec, n_layers=n_layers_dec, max_nodes=n_max_nodes)
